        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h2><p>Ajude-nos cadastrando torneios do seu estado, após o cadastro será enviado para a
                                aprovação!</p></h2>
                    </div>
                </div>
            </div>
                ...
                <form id="adicionar-campeonato">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mt-3 mt-md-0 pb-3">
                            ...
                            <input class="form-control" type="date" min="{{date('Y-m-d')}}" name="event_start_date"
                                   id="event_start_date"
                                   required>
                        </div>
                        ...
                        <div class="col-md-6 form-group mt-4 mt-md-0 pb-3">
                            ...
                            <input class="form-control" type="date" min="{{date('Y-m-d')}}" name="event_end_date"
            ...
            calendarEvents: [
                    @foreach($results as $data)
                {
                    ...
                    description:
                        ...
                        `</br> <b>Mais informações:</b> <a target="_blank" href="{{ $data->link_more_information }}">{{ $data->link_more_information }}</a>`,
